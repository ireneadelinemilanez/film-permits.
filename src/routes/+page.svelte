  <!-- Give's user oppurtunity to interact with website.  -->
...
<!-- Svelte's way of looping over an array, renders each item in the array, inside loop each individual record will be known as permit -->
...
<!-- If someone clicks on one of these divs, that permit becomes the selected vertical. This will then be able to appear on the page. It will then print out the additional information available from the data field. Also gives options to close containers. -->
